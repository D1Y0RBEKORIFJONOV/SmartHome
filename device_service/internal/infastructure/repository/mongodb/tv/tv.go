...
func (m *MongoDB) SaveUsersTV(ctx context.Context, req *tv_entity.TV) error {
...
func (m *MongoDB) SaveChannelsTV(ctx context.Context, req *tv_entity.Channel, userID string) error {
...
func (m *MongoDB) GetUsersChannel(ctx context.Context, req *tv_entity.GetUserChannelReq) (*tv_entity.GetUserChannelRes, error) {
	...
	for result.Next(ctx) {
		var userChannels struct {
			Channels []tv_entity.Channel `bson:"channels"`
		}
	...
	return &tv_entity.GetUserChannelRes{
		Channels: channels,
...
func (s *MongoDB) GetSoundTV(ctx context.Context, userID string) (*int, error) {
	filter := bson.M{"user_id": userID}
...
func (s *MongoDB) IsOnUsersTv(ctx context.Context, userID string) (bool, error) {
	filter := bson.M{"user_id": userID}
...
func (m *MongoDB) UpdateTVOn(ctx context.Context, userID string, val bool) error {
	filter := bson.M{"user_id": userID}
	update := bson.M{
		"$set": bson.M{
			"on": val,
