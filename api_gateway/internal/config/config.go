...
func New() *Config {
	...
	config.HttpPort = getEnv("RPC_PORT", "api_gateway:9002")
	...
	config.DevicePort = getEnv("MONGO_DEVICE_PORT", "device_service:9001")
	config.UserPort = getEnv("MONGO_USER_PORT", "user_service:9000")
